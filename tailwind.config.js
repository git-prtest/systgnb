    ...
    extend: {
      ...
      colors: {
        theme: {
          ...
          // Sidebar con imagen de fondo — colores como fallback
          sidebarbg: '#590F23',
          sidebarcolor: '#f0d4da',
          sidebarcaption: '#fce8ed',

          lightsidebarbg: '#fff',
          lightsidebarcolor: '#590F23',
          lightsidebarcaption: '#590F23',
        ...
        secondary: {
          DEFAULT: '#5B6B79',
          50: '#BEC6CE', 100: '#B2BCC5', 200: '#9BA8B4', 300: '#8394A2',
          400: '#6D8090', 500: '#5B6B79', 600: '#434F59', 700: '#2B3239',
          800: '#131619', 900: '#0B0D0F', 950: '#040506'
        },
        success: {
          DEFAULT: '#1DE9B6',
          50: '#C4F9EC', 100: '#B2F7E6', 200: '#8DF4DA', 300: '#67F0CE',
          400: '#42EDC2', 500: '#1DE9B6', 600: '#12BC91', 700: '#0D896A',
          800: '#085542', 900: '#03221B', 950: '#010907'
        },
        danger: {
          DEFAULT: '#F44236',
          50: '#FEE6E4', 100: '#FCD3D1', 200: '#FAAFAA', 300: '#F88B83',
          400: '#F6665D', 500: '#F44236', 600: '#E51A0D', 700: '#B0140A',
          800: '#7B0E07', 900: '#460804', 950: '#2B0502'
        },
        warning: {
          DEFAULT: '#F4C22B',
          50: '#FDF4DA', 100: '#FCEFC6', 200: '#FAE39F', 300: '#F8D879',
          400: '#F6CD52', 500: '#F4C22B', 600: '#DCA80B', 700: '#A67F09',
          800: '#715606', 900: '#3C2D03', 950: '#211902'
        },
        info: {
          DEFAULT: '#3EBFEA',
          50: '#E4F6FC', 100: '#D1F0FA', 200: '#ACE4F6', 300: '#88D7F2',
          400: '#63CBEE', 500: '#3EBFEA', 600: '#18A8D8', 700: '#1281A6',
          800: '#0D5A73', 900: '#073241', 950: '#041F27'
        },
        dark: {
          DEFAULT: '#212529',
          50: '#73818E', 100: '#6A7783', 200: '#58626D', 300: '#454E56',
          400: '#333940', 500: '#212529', 600: '#191C1F', 700: '#121417',
          800: '#0E0F11', 900: '#090A0B', 950: '#020303'
        }
      },
      backgroundImage: {
        ...
        'theme-bg-vino': 'linear-gradient(-135deg, #73142D 0%, #AB000F 100%)',
